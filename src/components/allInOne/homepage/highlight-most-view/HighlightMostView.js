...
const HighlightMostView = ({ loading, data }) => {
  return loading ? (
    <div className="p-5 h-[12vh] rounded-lg bg-secondary  grid md:grid-cols-4  grid-cols-1 gap-10">
          ...
          return (
            <SwiperSlide>
              ...
              >
                {/* images */}
                <div
                  className="relative rounded-full w-[80px] h-[80px] md:border-none border-2 border-accent md:p-0 p-1 md:md-0 mb-2"
                ...
                <div className="md:hidden block">
                  <article className="text-primary text-xs text-center uppercase">
                    {blog?.subcategory ? blog?.subcategory : blog?.category}
                  </article>
                  <article className="text-primary text-xs capitalize text-center">
