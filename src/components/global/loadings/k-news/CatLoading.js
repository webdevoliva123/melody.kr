            ...
            <div className='grid lg:grid-cols-[69.8%,28.3%] grid-cols-1 gap-5 mb-6'>
                <div className='w-full'>
                    <div className='w-full h-[60vh] bg-primary rounded-lg flex flex-col justify-center items-center mb-6'>
                        <Heading label={'FECTHING LATEST'} htype={1} custcss={'!text-primary  opacity-[0.2] md:mb-10 mb-5'} />
                        <Heading label={`${_name}`} custcss="md:!text-[80px] !text-[60px] !text-secondary !font-extrabold !uppercase opacity-[0.2]" />
                        <Heading label={'Section Data For You, Please Wait.'} htype={1} custcss={'!text-primary  opacity-[0.2] md:mt-10 mt-5'} />
                    </div>
